...
interface CertUploadDialogProps {
  ...
  /** Pre-picked file when the wallet dropzone receives a drop. */
...
export function CertUploadDialog({
  ...
  const selectedFile = file ?? initialFile;
    ...
    <Dialog open={open} onOpenChange={(next) => (next ? onOpenChange(true) : close())}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a certificate or licence to this worker&apos;s wallet. Expiry tracking is
            automatic.
          </DialogDescription>
        </DialogHeader>
